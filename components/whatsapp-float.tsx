...
export function WhatsappFloat() {
  return (
    <a
      ...
      className="whatsapp-pop fixed bottom-5 right-5 z-40 inline-flex items-center justify-center h-14 w-14 rounded-full bg-[#25D366] text-white shadow-[0_12px_30px_-10px_rgba(37,211,102,0.6)] hover:shadow-[0_20px_40px_-10px_rgba(37,211,102,0.75)] hover:scale-105 active:scale-95 transition-all duration-200"
    >
      <span
        aria-hidden
